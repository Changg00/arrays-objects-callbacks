...
function divider (numbersArray) {
  const evensArray = [];
  const oddsArray = [];
  const newArray = [evensArray, oddsArray];
...
// function divider(numbersArray){
//   const evens = numbersArray.filter(function(num) {return num % 2 === 0})
//   const odds = numbersArray.filter(function(num) {return num % 2 !== 0})
//   return [evens,odds]
// }
